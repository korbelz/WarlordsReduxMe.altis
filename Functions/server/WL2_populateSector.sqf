		...
		if (count _samArray > 0) then {
			{
				...
				_randomxtwo = random 200;
				_randomytwo = random 200;
				_randomztwo = 0;
				...
				_vehicleArray = [position _sector vectorAdd [_randomxtwo, _randomytwo, _randomztwo], 0, "I_E_SAM_System_03_F", _side] call BIS_fnc_spawnVehicle;
				_vehicleArray params ["_vehicle", "_crew", "_group"];
